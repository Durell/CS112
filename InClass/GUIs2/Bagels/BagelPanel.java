...
{
	// The following constants are used to indicate the cost of each
	// type of bagel.
	public final double WHITE_BAGEL = 1.25;
	public final double WHEAT_BAGEL = 1.50;


	// The following variables will reference radio buttons for White and 
	// whole wheat bagels.
	...
	// The getBagelCost method returns the cost of the selected bagel
